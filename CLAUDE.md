...
- `traceur-server/public/index.html` — tout le front en un seul fichier (HTML + CSS + JS vanilla, aucune lib) :
  ...
  - écran « Mon plan » (`screen-plan`) : les 14 prochains jours, un jour par carte (type de séance, description, statut), modifiable (marquer fait/manqué, changer le type d'un jour à venir) ;
